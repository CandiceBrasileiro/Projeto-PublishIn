  ...
  <>
    ...
    <section className=' w-80 h-96 shadow-lg shadow-gray-500/50 rounded-md stroke-[#A8A5A5] '>
      ...
      className='ml-10 mt-10'>
        ...
        <input type="submit" value="Login" className='mt-4 rounded-lg w-40 h-9 bg-[#385A64]  cursor-pointer border-slate-300 hover:border-slate-400 items-center text-white shadow-lg shadow-gray-500/50 ml-9'/>
      </form>
    </section>
    </main>
    </>
