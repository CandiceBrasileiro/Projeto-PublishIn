...
import imagemLogin from '../components/imgLogin.jpg';
    ...
    <>
      <main className=' bg-[#fff] max-w-7xl mx-auto flex mt-10 gap-5 items-center '>
        <section >
          <img
            src={imagemLogin}
            alt="Desenho colorido de livros, tinta, mulher, caneta tinteiro"
            className="max-w-[60%]"
          />
        </section>
        <section className='w-80 h-96 shadow-lg shadow-gray-500/50 rounded-md stroke-[#A8A5A5]'>
          <img
            src={logo}
            alt="Logomarca da página publishIn"
            className="mx-auto"
          />
          <form  
          ...
          className="ml-10 mt-10">
            <div>
              <label
                htmlFor="email"
                className="mt-1.5 mb-2 text-sm font-medium text-gray-900"
              >
                E-mail
              </label>
              <br />
            ...
            <input
              type="submit"
              value="Cadastre-se"
              className="mt-4 rounded-lg w-40 h-9 bg-[#385A64]  cursor-pointer border-slate-300 hover:border-slate-400 items-center text-white shadow-lg shadow-gray-500/50 ml-9"
            />
          </form>
        </section>
      </main>
